...
def keyword(
    ...
    key_dict = {'keyword': {keyword: {news.url: news.get_dict(
    ) for news in get_news(search_news(keyword))} for keyword in keywords}}
    ...
    with open('C:/Users/012/Desktop/git/NateNews/app/Seohyun/NateNews/src/flask/recommend.json', 'w', -1, 'utf-8') as f:
        json.dump(key_dict, f, indent=4, ensure_ascii=False)
    return key_dict
...
if __name__ == "__main__":
    ...
    keywords = keyword(model, doc, title, save=True)
    print(keywords.keys())
