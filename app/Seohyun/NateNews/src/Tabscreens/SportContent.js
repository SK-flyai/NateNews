      ...
      >
        ...
        <View>
          <Text style={{ padding: 5, marginTop: 10, fontSize: 15 }}>
            ...
            직원 B 씨를 흉기로 살해하고 도주했다. 그는 범행 후 계양구 효성동의
            한 아파트 인근에서 차고 있던 전자발찌를 훼손한 뒤 흰색 K5택시를 타고
            달아났다. 경찰에 따르면 A 씨는 키 170cm에 도주 당시 검은색 상하의를
            착용하고 있었다. 인천보호관찰소는 100여 명의 직원을 투입해 경찰과
            함께 폐쇄회로(CC)TV 등을 토대로 A 씨의 도주 경로를 추적 중이다.
            {"\n"}
            {"\n"}인천에서 편의점 직원을 흉기로 찔러 살해한 뒤 위치추적
            전자장치(전자발찌)를 훼손하고 도주한 30대 남성이 10대 때부터 상습
            강도질을 해온 것으로 전해졌다.경찰은 이 남성의 사진을 공개하고
